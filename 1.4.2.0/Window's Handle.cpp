...
LRESULT CALLBACK AboutProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	switch(msg)
	{
		...
		case WM_PAINT:
		{
			...
			DrawText(hdc, TEXT("版本：1.4.2.0                日期：2026.2.7"), -1, &RectDrawText, DT_LEFT | DT_SINGLELINE);
			...
			switch(wParam)
			{
				...
				case ID_Timer_LSelectHotkey://快捷键选择（左键）
				{
					...
					if(Target)
					{
						...
						g_FrameColor = RGB(g_ColorTable[g_ColorIndex].r, g_ColorTable[g_ColorIndex].g, g_ColorTable[g_ColorIndex].b);
						PostMessage(g_FrameHWND, WM_Frame, 0, (LPARAM)Target);
						char handle[HANDLESIZE];
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevIntance, LPSTR szCmdline, int iCmdShow)
{
	...
	g_WindowSize = AdjustClientSize(695, 338, true, &g_ClientSize, WS_OVERLAPPED | WS_VISIBLE | WS_SYSMENU | WS_CAPTION | WS_MINIMIZEBOX, NULL, NULL);//我算得的DIP为695, 338
