...
## 更新记录
- 1.4.5.0(2026.8.8)
  - 更新了**鼠标移动窗口**和**调整窗口大小**的按键判断，把Timer轮询换成低级鼠标钩子，视觉更加流畅<b>（接近Windows原生刷新率）</b>
  - 添加了托盘右键菜单条目，多了个“关于”菜单
  - 简化了冗余代码
- 1.4.4.0(2026.3.10)
  - 修复了快捷键**只有**“改窗口大小”时没有效果的问题
  - 修复了窗口位置输入框**不支持负数输入**的问题
- 1.4.3.0(2026.2.12)
